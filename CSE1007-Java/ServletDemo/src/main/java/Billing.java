...
public class Billing extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int t = (int)session.getAttribute("Total");
            session.setAttribute("Total", price+t);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Final bill</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Your bill is: Rs." + session.getAttribute("Total") + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
